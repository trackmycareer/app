...
// Search handles GET /certifications/search?q=<query>.
// Returns certification name and provider suggestions drawn from the user's
// existing data and a curated list of common certifications.
