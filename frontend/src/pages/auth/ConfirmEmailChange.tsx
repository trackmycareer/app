  ...
  useEffect(() => {
    ...
    apiClient.verification
      ...
      .then(async () => {
        ...
        // Refresh the JWT so it includes the new email
        try {
      ...
      >
        {status === "loading" && (
          <>
            ...
            />
            <p className="text-sm text-[var(--text-secondary)]">Confirming email change...</p>
          </>
        )}
        ...
        {status === "success" && (
          <>
            ...
            <p className="text-center text-sm text-[var(--text-secondary)]">
              Your email address has been changed successfully. Redirecting to your profile...
            </p>
          </>
        )}
